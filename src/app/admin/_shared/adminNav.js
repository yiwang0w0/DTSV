 ...
 *
 * page.js / Sidebar 共用：
 *   · TABS         —— 23 个 tab 的元数据（label / dataKey）。label 唯一真源（迁自 page.js）。
...
export const NAV_GROUPS = [
  { id: 'content', label: '内容创作', icon: '🔮',
    tabs: ['items', 'itemtags', 'itemrecipe', 'npcs', 'equipment', 'fragments', 'combos', 'classes', 'narrative'] },
  { id: 'world',   label: '世界·投放', icon: '🌍',
    tabs: ['roomsedit', 'chambers', 'placements', 'npcplace'] },
  { id: 'economy', label: '规则·经济', icon: '⚙️',
    tabs: ['rules', 'shop', 'points'] },
