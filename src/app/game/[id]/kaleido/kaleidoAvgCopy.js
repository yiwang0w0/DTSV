...
// 「再进」的回归行（Bug③）。觉醒行是**账号首次醒来**的叙事、只播一次；再进不能干巴巴什么都不说，
//   给一句「回来了」性质的叙述接上。
//   🚧 占位待 📖 供稿（🧭 已去要）：正式稿到了替换本常量即可，挂点与时序不用动。
//   口吻要求（教义 §2）：只描述世界与动作，不得写成「欢迎回来」这类系统宣告。
export const AVG_RESUME_LINE = '信号还在。你回到了刚才停下的地方。'
