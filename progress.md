...
2026-03-24
- Ŀ�꣺�޸� Vercel `next build` ��� Hook ������󣬲����뵱ǰ�ѱ�¶�� effect/font lint ���档
- ����ɣ�
  - `src/lib/server/gameActions.js` �� `useItem` ����Ϊ `performItemUse`������ `react-hooks/rules-of-hooks` ���С�
  - `src/app/admin/_tabs/UsersTab.jsx` �� `useCallback` ��װ `loadUsers`������ effect ������
  - `src/app/admin/page.js` ���� `router` ���������� `loadAll` �տ�Ϊ `useCallback`��
  - `src/app/layout.js` �� `src/app/globals.css` �л��� `next/font/google`�����Ѷദ `fontFamily` ��Ϊ CSS ������
- ��֤��
  - `node --check src/lib/server/gameActions.js` ͨ����
  - `node --check src/app/layout.js` ͨ����
  - `node --check src/app/admin/page.js` ͨ����
  - `npm.cmd run smoke` ͨ����
- ��ע���������� `next` ��ִ���ļ���δִ������ `npm run build`��
