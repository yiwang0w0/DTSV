...
export const getDeadStatus = (pid) =>
...
export const equipItem = (pid, index) =>
  api.post('/game/equip', { pid, index });
export const unequipItem = (pid, slot) =>
  api.post('/game/unequip', { pid, slot });
export const attack = (pid, eid) => api.post('/game/attack', { pid, eid });
export const dropItem = (pid, index) => api.post('/game/drop', { pid, index });
export const dropEquip = (pid, slot) =>
